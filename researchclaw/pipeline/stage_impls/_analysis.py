    ...
    if config.experiment.figure_agent.enabled and llm is not None:
        try:
            ...
            _fa_cfg = _FACfg(
                ...
                image_gen_enabled=config.experiment.figure_agent.image_gen_enabled,
                preferred_image_backend=config.experiment.figure_agent.preferred_image_backend,
                gemini_api_key=config.experiment.figure_agent.gemini_api_key,
                gemini_model=config.experiment.figure_agent.gemini_model,
                openai_api_key=config.experiment.figure_agent.openai_api_key,
                openai_base_url=config.experiment.figure_agent.openai_base_url,
                openai_image_model=config.experiment.figure_agent.openai_image_model,
                smart_excalidraw_url=config.experiment.figure_agent.smart_excalidraw_url,
                smart_excalidraw_llm_type=config.experiment.figure_agent.smart_excalidraw_llm_type,
                smart_excalidraw_llm_model=config.experiment.figure_agent.smart_excalidraw_llm_model,
                smart_excalidraw_llm_base_url=config.experiment.figure_agent.smart_excalidraw_llm_base_url,
                smart_excalidraw_llm_api_key=config.experiment.figure_agent.smart_excalidraw_llm_api_key,
